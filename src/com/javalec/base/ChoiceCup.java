...
public class ChoiceCup extends JDialog {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ChoiceCup dialog = new ChoiceCup();
	...
	private JLabel getLblTumbler() {
		if (lblTumbler == null) {
			...
			lblTumbler.setIcon(new ImageIcon(ChoiceCup.class.getResource("/image/Cuptb.png")));
	...
	private JLabel getLblCup() {
		if (lblCup == null) {
			...
			lblCup.setIcon(new ImageIcon(ChoiceCup.class.getResource("/image/Cupshop.png")));
